...
public class RangeReferenceNode implements JSONSSNode, JSONSSParserConstants
{
  ...
  public RangeReferenceNode(ASTRangeReference node) throws ParseException
  {
      ...
      if (ParserUtil.hasName(child, "ReferenceCellLocationSpecification")) {
        ...
        if (this.defaultCellLocationValueDirectiveNode != null)
          throw new RendererException(
            "only one default cell location value directive can be specified for a " + getNodeName());
        ...
        if (this.defaultLiteralValueDirectiveNode != null)
          throw new RendererException(
            "only one default literal value directive can be specified for a " + getNodeName());
        ...
        if (this.emptyCellLocationDirectiveNode != null)
          throw new RendererException("only one empty cell location directive can be specified for a " + getNodeName());
        ...
        if (this.emptyLiteralValueDirectiveNode != null)
          throw new RendererException("only one empty literal value directive can be specified for a " + getNodeName());
        ...
        if (this.shiftDirectiveNode != null)
          throw new RendererException("only one shift directive can be specified for a " + getNodeName());
  ...
  /**
   * Take a reference directives settings and override any that have been explicitly specified by the range
   * reference.
   */
  public ReferenceDirectivesSettings getCurrentReferenceDirectivesSettings(
    ReferenceDirectivesSettings enclosingRangeReferenceDirectivesSettings)
  {
    ReferenceTypeDirectiveSetting referenceTypeDirectiveSetting = hasExplicitlySpecifiedReferenceType() ?
      ...
      enclosingRangeReferenceDirectivesSettings.getReferenceTypeDirectiveSetting();
    EmptyCellLocationDirectiveSetting emptyCellLocationDirectiveSetting =
      hasExplicitlySpecifiedEmptyCellLocationDirective() ?
        ...
        enclosingRangeReferenceDirectivesSettings.getEmptyCellLocationDirectiveSetting();
